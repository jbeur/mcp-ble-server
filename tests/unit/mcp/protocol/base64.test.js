...
describe('Base64 Operations', () => {
  ...
  describe('Decoding', () => {
    ...
    it('should decode binary data correctly', () => {
      ...
      expect(decoded).toEqual(Buffer.from([0x00, 0xFF, 0x42, 0x7F]));
    });
  ...
  describe('Performance', () => {
    it('should handle encoding/decoding of large buffers efficiently', () => {
      ...
      sizes.forEach(size => {
        ...
        expect(avgTime).toBeLessThan(10); // Should complete within 10ms per iteration
      });
    });
  });
}); 